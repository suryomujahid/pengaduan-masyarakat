        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <div class="flex justify-between items-center p-5 rounded-t border-b dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-toggle="modal-add-user">
            ...
            <form action="{{route('admin.user.create')}}" method="post">
                ...
                <div class="p-6 space-y-6">
                    <div class="mb-6">
                        ...
                        <input type="text" id="name" name="name"
                            ...
                            placeholder="contoh: Joe Mama" required>
                    </div>
                    <div class="mb-6">
                        <label for="username"
                    ...
                    <div class="mb-6">
                        <label for="phone"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Nomor HP (opsional)</label>
                    ...
                    <div class="mb-6">
                        ...
                        <select id="user-role" name="role"
                            ...
                            @foreach (config('constant.user.roles') as $role)
                ...
                <div class="flex justify-end p-6 space-x-2 rounded-b border-t border-gray-200 dark:border-gray-600">
                    ...
                    <button data-modal-toggle="modal-add-user" type="button"

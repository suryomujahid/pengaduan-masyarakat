...
@section('content')
    ...
    <div class="my-4">
        <div class="flex flex-wrap justify-around">
            ...
            <a href="{{route('complaint.detail', $complaint['id'])}}" class="mr-2 my-2 flex flex-col items-center bg-white rounded-lg border shadow-md md:flex-row w-5/12 hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
